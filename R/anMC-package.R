#' @keywords internal
#' @details  Efficient estimation of high dimensional orthant probabilities. The package main functions are: \itemize{
...
#' }
#' @note This work was supported in part by the Swiss National Science Foundation, grant number 146354 and the Hasler Foundation, grant number 16065. Thanks to David Ginsbourger for the fruitful discussions and his continuous help in testing and improving the package.
#' @references Azzimonti, D. and Ginsbourger, D. (2018). Estimating orthant probabilities of high dimensional Gaussian vectors with an application to set estimation. Journal of Computational and Graphical Statistics, 27(2), 255-267. \doi{10.1080/10618600.2017.1360781}
#'
